...
type Match = { id: string; matchDate: string | null; roundName: string | null; venue: string | null; notes: string | null; firstHalfAttacksRight: boolean; competitionId: string; opponentClubId: string; club: { name: string }; opponentClub: { name: string }; competition: { name: string; season: { name: string } }; video: { storageStatus: "LOCAL" | "UPLOADING" | "READY" | "FAILED" } | null; _count: { playerActions: number; squad: number } };
