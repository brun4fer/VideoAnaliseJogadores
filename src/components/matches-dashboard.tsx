...
type Match = { id: string; matchDate: string | null; roundName: string | null; club: { name: string }; opponentClub: { name: string }; competition: { name: string; season: { name: string } }; video: unknown | null; _count: { playerActions: number } };
