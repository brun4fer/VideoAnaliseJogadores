...
export function SubactionWorkspace({ matchId }: { matchId: string }) {
  ...
  useEffect(() => {
    apiFetch<MatchDetail>(`/api/matches/${matchId}`).then((data) => {
      setMatch(data);
