...
export function Pitch({ points = [], value, onChange, onPointSelect, className }: { points?: PitchPoint[]; value?: Coordinate | null; onChange?: (coordinate: Coordinate) => void; onPointSelect?: (id: string) => void; className?: string }) {
